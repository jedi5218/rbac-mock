<template>
  <div style="max-width:360px;margin:80px auto;background:#fff;padding:32px;border-radius:8px;box-shadow:0 2px 12px rgba(0,0,0,.15)">
    <h2 style="margin-bottom:24px;text-align:center">RBAC Login</h2>
    ...
    <p style="margin-top:20px;text-align:center;font-size:0.85em;color:#888">Default: admin / admin123</p>
  </div>
</template>
